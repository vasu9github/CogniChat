...
const Sidebar = ({ isOpen, toggleSidebar, setSelectedChatId, startNewChat, chats, setChats }) => {
  ...
  return (
    ...
    // It is a flex item that transitions its width, which is more reliable.
    <aside
      className={`flex-shrink-0 bg-black h-full border-r border-gray-700 transition-all duration-300 ease-in-out
        ...
        <div className='p-4 border-b border-gray-700'>
          <div className='flex items-center justify-between mb-4'>
            ...
            <div className="flex items-center gap-2">
              ...
              {/* This close button is now part of the main sidebar flow */}
              <button onClick={toggleSidebar} className='p-2 rounded-md hover:bg-gray-700 transition-colors md:hidden'>
                <X size={20} color='white' />
              </button>
            </div>
